...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_ergodox_pretty(
    KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    META,       META,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_ESC,
    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    SUPER,      SUPER,   KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSLS,
    KC_GRV,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                         KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    CONTROL,    CONTROL, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
    ADMIN,   _______, _______, KC_EQL,  KC_MINS,                                        KC_LBRC, KC_RBRC, _______, _______, ADMIN,
  ...
  [FN] = LAYOUT_ergodox_pretty(
    ...
    _______, _______, _______, _______, _______,                                        _______, _______, _______, _______, _______,
                                                 _______, _______,    _______, _______,
                                                          _______,    _______,
                                        _______, _______, _______,    _______, KC_CAPS, KC_PSCREEN
  ),
  ...
  [ADMIN] = LAYOUT_ergodox_pretty(
    ...
    _______, _______, _______, _______, _______,                                         _______, _______, _______, _______, _______,
                                                 _______, RESET,       RESET,   _______,
                                                          _______,     _______,
                                        LED_LVL, _______, _______,     _______, _______, LED_LVL
  ),
};
